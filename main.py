...
parser.add_argument('--epoch_step', default=[8, 13, 16, 18], type=int, nargs='+',
...
def multiLabel_text_classify():
    ...
    model = gcn_bert(num_classes=len(train_dataset.tag2id), t=0.05, co_occur_mat=train_dataset.co_occur_mat)
