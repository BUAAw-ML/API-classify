...
parser.add_argument('--epoch_step', default=[15, 18], type=int, nargs='+',
...
def multiLabel_text_classify():
    ...
    train_dataset, val_dataset, encoded_tag, tag_mask, tag_embedding_file = \
        load_dataset('data/ProgrammerWeb/programmerData-subCategory.csv.csv', 'data/ProgrammerWeb/domainnet.csv')
