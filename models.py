...
class GCNBert(nn.Module):
    ...
    def get_config_optim(self, lr, lrp):
        return [
                ...
                {'params': self.bert.encoder.layer[3].parameters(), 'lr': 0.001},
                {'params': self.bert.encoder.layer[2].parameters(), 'lr': 0.001},
                {'params': self.bert.encoder.layer[1].parameters(), 'lr': 0.001},
                {'params': self.bert.encoder.layer[0].parameters(), 'lr': 0.001},
