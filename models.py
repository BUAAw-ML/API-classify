...
class GCNBert(nn.Module):
    ...
    def forward(self, ids, token_type_ids, attention_mask, inputs_tfidf, encoded_tag, tag_mask, tag_embedding_file, tfidf_result):
        ...
        weight1 = torch.nn.ReLU(self.weight1(attention_out))
        ...
        weight2 = torch.nn.ReLU(self.weight2(x))
        weight2 = weight2.squeeze(-1).unsqueeze(0)
        ...
        pred = weight1 * attention_out + weight2 * x
