...
|---|---|---|---|  
L,U,T: 200,,2510（split: 200,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;||
L,U,T: 400,,2510（split: 400,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;||
L,U,T:1600,,2510（split:1600,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;||
L,U,T:6400,,2510（split:6400,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;||
|---|---|---|---| 
L,U,T: 200,   ,2170（split: 200,标签数：150）|Bert微调+多注意力+Sum|epoch: 50;ES:40;BS:4;|map=37.864 OP=0.511 OR=0.360 OF1=0.423 CP=0.403 CR=0.427 CF1=0.415|
L,U,T: 400,   ,2170（split: 400,标签数：150）|Bert微调+多注意力+Sum|epoch: 50;ES:40;BS:4;|map=38.254 OP=0.527 OR=0.382 OF1=0.443 CP=0.490 CR=0.342 CF1=0.403|
L,U,T:1600,   ,2170（split:1600,标签数：150）|Bert微调+多注意力+Sum|epoch: 50;ES:40;BS:4;|map=43.221 OP=0.520 OR=0.483 OF1=0.501 CP=0.511 CR=0.426 CF1=0.464|
L,U,T:6400,   ,2170（split:6400,标签数：150）|Bert微调+多注意力+Sum|epoch: 50;ES:40;BS:4;|map=49.105 OP=0.520 OR=0.474 OF1=0.496 CP=0.488 CR=0.482 CF1=0.485|
|---|---|---|---|  
...
|---|---|---|---|
L,U,T: 200,,2566（split: 200,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;||
L,U,T: 400,,2566（split: 400,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;||
L,U,T:1600,,2566（split:1600,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;||
L,U,T:6400,,2566（split:6400,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;||
|---|---|---|---| 
...
L,U,T:6400,   ,2566（split:6400,标签数：200）|Bert微调+多注意力+Sum|epoch: 50;ES:40;BS:4;||
|---|---|---|---|   