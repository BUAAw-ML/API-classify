...
|---|---|---|---|  
L,U,T: 200,   ,2170（split: 200,标签数：50）|Bert+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=49.750 OP=0.580 OR=0.448 OF1=0.506 CP=0.551 CR=0.494 CF1=0.521|
L,U,T: 400,   ,2170（split: 400,标签数：50）|Bert+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=52.021 OP=0.620 OR=0.450 OF1=0.521 CP=0.602 CR=0.479 CF1=0.533|
L,U,T:1600,   ,2170（split:1600,标签数：50）|Bert+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=57.831 OP=0.591 OR=0.549 OF1=0.569 CP=0.609 CR=0.549 CF1=0.577|
L,U,T:6400,   ,2170（split:6400,标签数：50）|Bert+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=63.142 OP=0.616 OR=0.562 OF1=0.588 CP=0.667 CR=0.553 CF1=0.604|
|---|---|---|---|  

tags<100 样本数量最多的前100个tag   zyc
数据配置|模型方法|训练参数|实验结果|                                                                                                                                                                    
|---|---|---|---|   
L,U,T: 200,   ,2418（split: 200,标签数：100）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=27.756 OP=0.555 OR=0.226 OF1=0.321 CP=0.428 CR=0.153 CF1=0.225|
L,U,T: 200,500,2418（split: 200,标签数：100）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=36.122 OP=0.666 OR=0.202 OF1=0.310 CP=0.417 CR=0.141 CF1=0.211|
L,U,T: 400,   ,2418（split: 400,标签数：100）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=39.342 OP=0.632 OR=0.299 OF1=0.406 CP=0.516 CR=0.272 CF1=0.356|
L,U,T: 400,500,2418（split: 400,标签数：100）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=41.879 OP=0.672 OR=0.281 OF1=0.396 CP=0.551 CR=0.230 CF1=0.325|
L,U,T:1600,   ,2418（split:1600,标签数：100）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=46.555 OP=0.653 OR=0.402 OF1=0.497 CP=0.643 CR=0.361 CF1=0.462|
L,U,T:1600,500,2418（split:1600,标签数：100）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=49.530 OP=0.637 OR=0.393 OF1=0.486 CP=0.624 CR=0.354 CF1=0.451|
L,U,T:6400,   ,2418（split:6400,标签数：100）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=54.261 OP=0.622 OR=0.457 OF1=0.527 CP=0.579 CR=0.474 CF1=0.521|
L,U,T:6400,500,2418（split:6400,标签数：100）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=54.852 OP=0.588 OR=0.502 OF1=0.542 CP=0.613 CR=0.458 CF1=0.524|
|---|---|---|---|  
L,U,T: 200,   ,2418（split: 200,标签数：100）|Bert+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=28.694 OP=0.588 OR=0.220 OF1=0.320 CP=0.420 CR=0.150 CF1=0.221|
L,U,T: 400,   ,2418（split: 400,标签数：100）|Bert+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=38.320 OP=0.643 OR=0.278 OF1=0.388 CP=0.558 CR=0.230 CF1=0.326|
L,U,T:1600,   ,2418（split:1600,标签数：100）|Bert+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=47.114 OP=0.642 OR=0.396 OF1=0.490 CP=0.641 CR=0.347 CF1=0.450|
L,U,T:6400,   ,2418（split:6400,标签数：100）|Bert+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=51.191 OP=0.648 OR=0.415 OF1=0.506 CP=0.568 CR=0.391 CF1=0.463|
|---|---|---|---|  


tags<150 样本数量最多的前150个tag   zyc
数据配置|模型方法|训练参数|实验结果|                                                                                                                                                                    
|---|---|---|---|   
L,U,T: 200,   ,2510（split: 200,标签数：150）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=26.668 OP=0.493 OR=0.207 OF1=0.291 CP=0.435 CR=0.145 CF1=0.217|
L,U,T: 200,500,2510（split: 200,标签数：150）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=33.385 OP=0.627 OR=0.168 OF1=0.265 CP=0.389 CR=0.116 CF1=0.178|
L,U,T: 400,   ,2510（split: 400,标签数：150）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=32.429 OP=0.602 OR=0.253 OF1=0.356 CP=0.482 CR=0.179 CF1=0.261|
L,U,T: 400,500,2510（split: 400,标签数：150）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=37.874 OP=0.653 OR=0.242 OF1=0.354 CP=0.412 CR=0.161 CF1=0.232|
L,U,T:1600,   ,2510（split:1600,标签数：150）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=42.640 OP=0.595 OR=0.419 OF1=0.492 CP=0.563 CR=0.342 CF1=0.425|
L,U,T:1600,500,2510（split:1600,标签数：150）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=44.800 OP=0.616 OR=0.404 OF1=0.488 CP=0.564 CR=0.337 CF1=0.421|
L,U,T:6400,   ,2510（split:6400,标签数：150）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=49.770 OP=0.645 OR=0.401 OF1=0.494 CP=0.593 CR=0.380 CF1=0.463|
L,U,T:6400,500,2510（split:6400,标签数：150）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=49.577 OP=0.604 OR=0.480 OF1=0.535 CP=0.561 CR=0.425 CF1=0.484|
|---|---|---|---|  
