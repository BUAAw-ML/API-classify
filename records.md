...
|---|---|---|---|  
L,U,T: 200,500,2418（split: 200,标签数：100）|Bert微调+多注意力GAN3|epoch:100;ES:90;BS:4|map=46.613 OP=0.637 OR=0.315 OF1=0.421 CP=0.645 CR=0.270 CF1=0.381|
L,U,T: 400,500,2418（split: 400,标签数：100）|Bert微调+多注意力GAN3|epoch:100;ES:90;BS:4|map=54.524 OP=0.625 OR=0.444 OF1=0.519 CP=0.668 CR=0.412 CF1=0.510|
L,U,T:1600,500,2418（split:1600,标签数：100）|Bert微调+多注意力GAN3|epoch:100;ES:90;BS:4|map=60.720 OP=0.694 OR=0.488 OF1=0.573 CP=0.725 CR=0.479 CF1=0.577|
L,U,T:6400,500,2418（split:6400,标签数：100）|Bert微调+多注意力GAN3|epoch:100;ES:90;BS:4|map=65.096 OP=0.675 OR=0.487 OF1=0.566 CP=0.741 CR=0.497 CF1=0.595|
L,U,T:8284,500,2418（split:8284,标签数：100）|Bert微调+多注意力GAN3|epoch:100;ES:90;BS:4|map=65.426 OP=0.726 OR=0.478 OF1=0.576 CP=0.764 CR=0.470 CF1=0.582|
|---|---|---|---|  
...
数据配置|模型方法|训练参数|实验结果|                                                                                                                                                                    
|---|---|---|---|   
L,U,T: 200,   ,2566（split: 200,标签数：200）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=24.543 OP=0.565 OR=0.169 OF1=0.261 CP=0.375 CR=0.121 CF1=0.183|
...
L,U,T: 400,   ,2566（split: 400,标签数：200）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=29.009 OP=0.572 OR=0.249 OF1=0.347 CP=0.383 CR=0.154 CF1=0.220|
...
L,U,T:1600,   ,2566（split:1600,标签数：200）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=40.368 OP=0.610 OR=0.356 OF1=0.450 CP=0.541 CR=0.275 CF1=0.365|
...
L,U,T:6400,   ,2566（split:6400,标签数：200）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=46.853 OP=0.594 OR=0.407 OF1=0.483 CP=0.554 CR=0.356 CF1=0.433|
...
L,U,T:9710,   ,2566（split:9517,标签数：150）|Bert微调+多注意力    |epoch: 50;ES:40;BS:4;|map=48.201 OP=0.568 OR=0.437 OF1=0.494 CP=0.548 CR=0.375 CF1=0.445|
L,U,T:9710,500,2566（split:9517,标签数：150）|Bert微调+多注意力+GAN|epoch:100;ES:90;BS:4;|map=47.095 OP=0.661 OR=0.399 OF1=0.498 CP=0.598 CR=0.321 CF1=0.418|
|---|---|---|---|
L,U,T: 200,,2566（split: 200,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=33.809 OP=0.519 OR=0.326 OF1=0.400 CP=0.374 CR=0.381 CF1=0.377|
L,U,T: 400,,2566（split: 400,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=36.038 OP=0.494 OR=0.386 OF1=0.433 CP=0.477 CR=0.326 CF1=0.388|
L,U,T:1600,,2566（split:1600,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=40.737 OP=0.522 OR=0.421 OF1=0.466 CP=0.498 CR=0.368 CF1=0.423|
L,U,T:6400,,2566（split:6400,标签数：150）|Bert微调+多注意力+Linear|epoch: 50;ES:40;BS:4;|map=45.910 OP=0.561 OR=0.443 OF1=0.495 CP=0.541 CR=0.397 CF1=0.458|
|---|---|---|---| 
